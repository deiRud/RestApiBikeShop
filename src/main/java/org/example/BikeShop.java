...
public class BikeShop {
    public static void main(String[] args) {
        ...
        Product[] mountainbikes = {
                new Product(1,"BULLS", "Copperhead 2 27,5", "Kettenschaltung | 20 Gang", "999,95",
                        new Color[]{new Color("#FF6347", "images/Copperhead_2_27_5.png"), new Color("#000000", "images/Copperhead_2_27_5_black.png")}),
                new Product(2,"BULLS", "Copperhead 3 29", "Kettenschaltung | 11 Gang", "1.399,00",
                ...
                new Product(3,"BULLS", "Sharptail 2 Disc 29", "Kettenschaltung | 27 Gang", "799,99",
        ...
        Product[] emtb = {
                new Product(4,"KTM", "MACINA KAPOHO 7972", "Kettenschaltung | 12 Gang", "5.899,00",
                        new Color[]{new Color("#D3D3D3", "images/Macina_kapoho_7972.png")}),
                new Product(5,"KTM", "MACINA KAPOHO 7973", "Kettenschaltung | 20 Gang", "5.299,00",
                        new Color[]{new Color("#000000", "images/Macina_kapoho_7973_black.png"), new Color("#0096FF", "images/Macina_kapoho_7973_blue.png")}),
                new Product(6,"BULKTMLS", "MACINA KAPOHO 7971", "Kettenschaltung | 12 Gang", "6.299,00",
                        new Color[]{new Color("#8b0000", "images/Macina_kapoho_7971_red.png")})
        };

        Product[] accessories = {
                new Product(7,"AXA", "RLC 140 Plus", "", "35,00", new Color[]{new Color("#000000", "images/rlc_140_plus.png")}),
                new Product(8,"AXA", "RLC PLUS 100/5,5", "", "19,99", new Color[]{new Color("#000000", "images/rlc_plus_100_5_5.png")}),
                new Product(9,"AXA", "Flex Mount", "", "11,00", new Color[]{new Color("#000000", "images/flex_mount.png")})
        };
